...
Todas as atividades presentes no texto foram consideradas atividades de autoavaliação.

### Espaço para realizações das atividades

A verificação de espaços para realizações das atividades é relativamente fácil, basta procurar por linhas ou lacunas para o preenchimento nas atividades. Atividades de marcar Verdadeiro (V) ou Falso (F) quase sempre proporcionam o espaço para seu preenchimento.
